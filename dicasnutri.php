                ...
                <article class="feira">
                    ...
                    <ol>
                        <li>
                            ...
                            Existe, para cada fruta e hortaliça, a melhor época de consumo, quando a produção é farta,
                            saborosa, barata e mais fácil de conservar. <br> <br>
                        </li>
                        <li><b>Busque um alimento seguro.</b><br>
                            “A melhor forma é o consumo da fruta e hortaliça na sua melhor época de produção, quando
                            existe menor necessidade de utilização de insumos e, consequentemente, de agrotóxicos”.</li>
                        <br>
                        <li> <b>Observe os alimentos.</b> <br>
                            Na hora de escolher o produto é fundamental reparar na sua aparência. “Os produtos deverão
                            estar frescos, firmes, com coloração viva e sem sinal de deterioração. A qualidade deles
                            está relacionada à aparência visual, textura, sabor, aroma, valor nutricional,
                            acondicionamento entre outros fatores”.</li> <br>

                        <li><b>Atente-se aos preços e evite o desperdício.</b> <br>
                            O barato pode sair caro. Não compre só porque o preço está baixo, a não ser que ele seja
                            causado pela alta oferta – pico de produção. Procure comprar a quantidade ideal para o seu
                            consumo, assim evitando o desperdício de alimentos.</li><br>

                        <li><b>Tenha cuidados após levar os produtos para casa.</b><br>
                            - Frutas e hortaliças-fruto (abóbora, moranga, tomate, pimentão colorido) deixe amadurecerem
                            bem antes de refrigerá-las.
                            - As hortaliças-folha (acelga, agrião, alface, almeirão, cebolinha, couve, escarola,
                            repolho, serralha, rúcula, salsinha), flor (alcachofra, couve-flor,brócolos) e talo (aipo,
                            alho-poró, aspargo, erva doce, salsão) são muito tenras e sensíveis devem ser armazenadas,
                            refrigeradas e protegidas contra a perda de umidade em sacos plásticos (perfurados). E devem
                            ser separadas das frutas amadurecendo”.</li> <br>

                        <li><b>Só lave ou corte as frutas e hortaliças um pouco antes do seu consumo ou preparo.</b>
                            <br>
                   ...
                   <br>
                    ...
                    <ul>
                        ...
                        <li>Selecionar retirando unidades deterioradas, e no caso das hortaliças folhosas, retirar
                            folhas e partes deterioradas.</li>
                        <li>Lavar em água corrente cada produto (folha por folha, fruta por fruta etc.), esfregando
                            levemente com os dedos todos os lados para retirar as sujidades e ovos de parasitas que
                            podem estar aderidos.</li>
                        <li>Colocar em solução clorada, utilizando produto adequado para este fim e seguir as
                            orientações do fabricante no rótulo da embalagem.</li>
                        <li>Enxaguar em água corrente.</li>
