...
<body>
    ...
    <main>
        ...
        <article class=" limitador2 caixa">
            ...
            <div class="fotoeli">
                <figure><img src="imagens/imagem home.jpg" alt=""></figure></div>


           <div class="offerservicos">
            <h2>OS SERVIÇOS QUE OFEREÇO</h2> <br>
            <figure><a href="servicos.html"><img src="imagens/dieta.png" alt=""></a><p> Avaliação Nutricional</p></figure><br>

            <figure><a href="servicos.html"><img src="imagens/fita-metrica.png" alt=""></figure></a><p>Avaliação Antropométrica </p> <br>

            <figure><a href="servicos.html"><img src="imagens/pinca.png" alt=""></figure></a>
            <p>Exame Biompendância</p> <br>

            <figure><a href="servicos.html"><img src="imagens/apoio-suporte.png" alt=""></figure></a>
...
<div class="dicasnutri">
       <br>
        <div>
            <a href="dicasnutri.html"><img src="imagens/dicafeira.jpg" alt=""></a>
            <p>Boas Escolhas na Feira!</p>

        </div>
        <div>
            <a href="dicasnutri.html"><img src="imagens/dicalavar.jpg" alt=""></a>
            <p>Higienização dos Produtos!</p>

        </div>
        <div>
           <a href="dicasnutri.html"><img src="imagens/dicaorganizar.jpg" alt=""></a>
            <p>Cuidados no Armazenamento!</p>

        </div>
        <div>
            <a href="dicasnutri.html"><img src="imagens/dicaervas.jpg" alt=""></a>
            <p>Ervas e Condimentos!</p>

        </div>
        <div>
            <a href="dicasnutri.html"> <img src="imagens/dicaagua.jpg" alt=""></a>
            <p>Agua Saborizada!</p>
...
<br> <address class="belavista">Rua Cincinato Braga, 340 – 6º e 10º andar – Cond. Edificio Delta Plaza
